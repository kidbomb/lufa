...
#define _DESCRIPTORS_H_
	...
	/* Macros: */
		...
		#define CCID_IN_EPADDR       (ENDPOINT_DIR_IN  | 1)
		...
		/** Endpoint address of the CCID interrupt IN endpoint, for device-to-host data transfers. */
		#define CCID_INTERRUPT_EPADDR      (ENDPOINT_DIR_IN | 2)

		/** Endpoint size in bytes of the CCID  IN and OUT endpoints. */
	...
	/* Type Defines: */
		...
		typedef struct
		{
			...
			USB_Descriptor_Endpoint_t				CCID_InterruptInEndpoint;
